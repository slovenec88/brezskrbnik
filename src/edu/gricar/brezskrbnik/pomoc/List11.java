...
public class List11 extends ListActivity {
    ...
    private static final String[] GENRES = new String[] {
        "Dexter", "Crocodile", "Popping Cherry", "Let's Give the Boy a Hand", "Love American Style", "Return to Sender",
        "Circle of Friends", "Shrink Wrap", "Father Knows Best", "Seeing Red", "Truth Be Told", "Born Free", "Sonèek"
    };
}
